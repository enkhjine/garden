...
public class AuthenticationFilter implements Filter {
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1,
		...
		if (request.getSession().getAttribute(UserSessionController.AUTH_KEY) == null || 
			...
			String url = request.getSession().getAttribute(UserSessionController.urlList) == null ? "Hospital/::home.html::"
					+ "company/list.html::"
			...
			String url = request.getSession().getAttribute(UserSessionController.urlList) == 
					null ? "Hospital/" : request.getSession().getAttribute(UserSessionController.urlList).toString();
			String[] list = url.split("::");

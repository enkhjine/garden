...
public class Tool {
	...
	public static String DISCOUNTTYPETREATMENT = "TREATMENT";
    ...
    public static final String MAN = "Эрэгтэй";
    public static final String WOMAN = "Эмэгтэй";
    
    public static final String CustomerRegTypeChild = "Child";
	public Tool(){
	...
	public static List<String> getMedicalHistoryNames(){
		...
		list.add("Гепатит С");
		list.add("ХДХВ");
		list.add("Салхин цэцэг");
		list.add("Гэдэсний халдвар");
		list.add("ДОХ");
		list.add("Гахайн хавдар");
		list.add("Уушигны сүрье");
		list.add("Гепатит А");
		list.add("Булчирхайн сүрье");
		list.add("Гепатит В");
		list.add("Гэдэсний сүрье");
		
		list.add("Тайлбар");
		
		list.add("Халдвар ба паразитын өвчин");
		list.add("Хорт хавдар");
		list.add("Цусны эмгэг");
		list.add("Дотоод шүүрлийн булчирхай");
		list.add("Сэтгэл мэдрэлийн эмгэг");
		list.add("Мэдрэлийн системийн эмгэг");
		list.add("Нүдний эмгэг");
		list.add("Чих, хөхлөг ургацгийн эмгэг");
		list.add("Цусны эргэлтийн системийн эмгэг");
		list.add("Амьсгалын системийн эмгэг");
		list.add("Хоол боловсруулах системийн өвчин");
    ...
    public static BigDecimal calculateDiscountAmount(BigDecimal amount, BigDecimal discountPercent){
    	...
    	if(discountAmount.compareTo(new BigDecimal(0)) > 0 && discountPercent.compareTo(new BigDecimal(100)) < 0){

...
public class Message {
	...
	public Message() {
		...
		messages.set(37, new Msg("Нэвтрэлт амжилтгүй боллоо. Лицензийн файлыг хуулна уу!", Tool.msgError));
		messages.set(38, new Msg("Хөнгөлөлттөй дүн оруулсан тохиолдолд заавар тайлбар бичнэ үү!!!", Tool.msgWarning));
		messages.set(39, new Msg("Тайлбар бичихдээ дор хаяж 5 тэмдэгч бичнэ үү!!!", Tool.msgWarning));
		messages.set(40, new Msg("XLS - ээс мэдээлэлүүдээ амжилттай татлаа", Tool.msgSuccess));
		messages.set(41, new Msg("", Tool.msgSuccess));
		messages.set(42, new Msg("", Tool.msgSuccess));
		messages.set(43, new Msg("Барааны ашиглах хэмжээг оруулна уу", Tool.msgWarning));
